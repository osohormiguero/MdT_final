...
//La función vieja para settear el duty cycle de la bomba
/*  
static void comSetBombaDutyCycle(){
    float dutyCycle_valor;
    usbPort_pc_serial_com.printf("Ingresa una intensidad entre 0.0 y 1.0: \n");
    usbPort_pc_serial_com.scanf("%f", &dutyCycle_valor);
    usbPort_pc_serial_com.printf("El duty cycle de la bomba cambiara a: %f\n", dutyCycle_valor); 
    setBombaDutyCycle(dutyCycle_valor);
    }
*/
